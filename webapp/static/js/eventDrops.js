    ...
    var eventLine = function eventLine(selection) {
      selection.each(function (data) {
        ...
        circle.enter()
          ...
          .attr('cy', -5)
          .attr('r', function(d){return Math.pow(d.size*1.0/2.0,1/3)}).attr('index',function(d,i){return i;}).attr('id',function(d,i){return d.id;})
        ;
...
module.exports = function (d3, config, xScale, graph, graphHeight, where) {
  ...
  var y = (where == 'bottom' ? parseInt(graphHeight) : 0) + config.margin.top - 35;
